...
Engine::OrthographicCameraController::OrthographicCameraController(
...
void Engine::OrthographicCameraController::OnEvent(Event& event)
{
    ...
    dispatcher.Dispatch<MouseScrolledEvent>(
        ENGINE_BIND_EVENT_FN(OrthographicCameraController::OnMouseScrolled));
    dispatcher.Dispatch<WindowResizeEvent>(
        ENGINE_BIND_EVENT_FN(OrthographicCameraController::OnWindowResized));
}

bool Engine::OrthographicCameraController::OnMouseScrolled(
...
bool Engine::OrthographicCameraController::OnWindowResized(
