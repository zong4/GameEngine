...
#include "Platform/Renderer/OpenGL/imgui_impl_opengl3.h"
...
bool Engine::ImGuiLayer::OnKeyPressedEvent(KeyPressedEvent& event)
{
    ...
    io.KeyCtrl =
        (ImGuiKey)event.GetKeyCode() == ImGuiKey_LeftCtrl || (ImGuiKey)event.GetKeyCode() == ImGuiKey_RightCtrl;
    io.KeyShift =
        (ImGuiKey)event.GetKeyCode() == ImGuiKey_LeftShift || (ImGuiKey)event.GetKeyCode() == ImGuiKey_RightShift;
    io.KeyAlt = (ImGuiKey)event.GetKeyCode() == ImGuiKey_LeftAlt || (ImGuiKey)event.GetKeyCode() == ImGuiKey_RightAlt;
    io.KeySuper =
        (ImGuiKey)event.GetKeyCode() == ImGuiKey_LeftSuper || (ImGuiKey)event.GetKeyCode() == ImGuiKey_RightSuper;
