...
//  (ImGuiBackendFlags_RendererHasVtxOffset) [Desktop OpenGL only!]
...
//  2025-02-18: OpenGL: Lazily reinitialize embedded GL loader for when calling backend from e.g. other DLL boundaries.
//  (#8406) 2024-10-07: OpenGL: Changed default texture sampler to Clamp instead of Repeat/Wrap. 2024-06-28: OpenGL:
//  ImGui_ImplOpenGL3_NewFrame() recreates font texture if it has been destroyed by
...
//   Typically you would run: python3 ./gl3w_gen.py --output ../imgui/backends/imgui_impl_opengl3_loader.h --ref
...
void ImGui_ImplOpenGL3_RenderDrawData(ImDrawData* draw_data)
{
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++) {
        ...
        if (bd->UseBufferSubData) {
            ...
            GL_CALL(glBufferData(GL_ARRAY_BUFFER, vtx_buffer_size, (const GLvoid*)draw_list->VtxBuffer.Data,
                                 GL_STREAM_DRAW));
